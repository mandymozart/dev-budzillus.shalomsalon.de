...
function wp_bandcamp_build_movie_url ( $atts )
{
	...
	return "http://bandcamp.com/EmbeddedPlayer/v=2/$type=$id/size=$size/bgcol=$bgcol/linkcol=$linkcol/$transparent_text/minimal=true";
}
...
function wp_bandcamp_embed_player ( $atts )
{
	...
	return '<iframe width="' . $width . '" height="' . $height . '" src="' . $movieUrl . '" style="position:relative;display:initial;width:' . $width . 'px;height:' . $height . 'px;" allowtransparency="true" frameborder="0"></iframe>';
}
